...
akurat tej metody, oraz omówienie rozwiązań alternatywnych, zamieszczono na końcu tej sekcji.
...
przechowywać listy wierzchołków. Rozwiązanie to odrzucono, ponieważ działka na Mazurach ma kształt
...
W literaturze dotyczącej problemu PIP zidentyfikowano również algorytm winding number, który zlicza,
...
wielokąta. W kontekście niniejszego projektu rozróżnienie to jest jednak akademickie: GPS dokładny do kilku
metrów nigdy nie wyląduje na krawędzi wierzchołka zdefiniowanego przez użytkownika klikającego
na ekranie. Wybór padł na ray casting, ponieważ implementacja jest krótsza, prostsza do zrozumienia
