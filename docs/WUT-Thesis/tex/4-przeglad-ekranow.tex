...
warstwę serwisową, która izoluje resztę aplikacji od szczegółów protokołu AIDL.
...
\captionof{figure}{Struktura pakietu \texttt{ui}}
...
typografię oraz motyw Material Design 3.
Struktura pakietu \texttt{ui} przedstawia się rysunekem~\ref{fig:ui-structure}.
